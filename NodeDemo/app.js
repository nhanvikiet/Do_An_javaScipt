...
var productRoutes = require('./routes/productRoutes');  // Thêm dòng này
var categoryRoutes = require('./routes/categoryRoutes');  // Thêm dòng này
...
// Trong file app.js hoặc trong file authen.js (tùy thuộc vào cách bạn tổ chức routes)
